...
public class ejercicio13 {
    ...
    /** Esta funcion muestra por pantalla todos los elementos de un arreglo tipo Double, de forma recursiva
     * 
     * @param array se trata del arreglo a mostrar
     * @param base se trata del limite, hasta que valor va a invocarse recursivamente
     * @param i se trata del indice, nos indica donde nos vamos a posicionar en el arreglo
     */
    
    public static void mostrarArray(double[] array, int base, int i){
    ...
    public static void main(String[] args){
        ...
        mostrarArray(precios, precios.length, 0);
